...
const Home = () => {
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans overflow-hidden">
      ...
      <section className="relative px-6 pt-16 pb-40 max-w-6xl mx-auto">
        
       
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-emerald-500/20 rounded-full blur-3xl" />
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-rose-500/10 rounded-full blur-3xl" />
        
        <div className="relative z-10">
      
          <div className="inline-flex items-center gap-3 bg-emerald-500/10 backdrop-blur-sm border-2 border-emerald-500/30 rounded-full px-5 py-2.5 mb-12">
          ...
          <h1 className="text-5xl sm:text-6xl font-black text-white leading-none tracking-tighter mb-8">
            Niko Kadi.
          </h1>
          <h2 className="text-4xl sm:text-5xl font-black leading-none tracking-tighter mb-10">
            <span className="bg-gradient-to-r from-emerald-400 via-emerald-300 to-teal-400 bg-clip-text text-transparent">
              Je, wewe?
            </span>
          </h2>

          <p className="text-zinc-300 text-xl sm:text-2xl leading-relaxed max-w-3xl mb-14 font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5 mb-16">
            <Link
              to="/pin-location"
              className="group relative overflow-hidden bg-emerald-500 hover:bg-emerald-400 text-black font-black text-lg px-8 py-4 
              rounded-2xl transition-all duration-300 shadow-2xl shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:scale-105"
            >
            ...
            <Link
              to="/chukua-card"
              className="group bg-zinc-900 hover:bg-zinc-800 text-white font-bold text-lg px-8 py-4 rounded-2xl border-2 border-zinc-700
          ...
          <div className="flex items-center gap-6">
            <span className="text-zinc-500 text-sm font-bold uppercase tracking-widest">Share the movement</span>
            <div className="flex gap-4">
              <a 
                href="https://twitter.com/intent/tweet?text=Niko+Kadi+%F0%9F%87%B0%F0%9F%87%AA+%23NikoKadi+%23RegisterToVote" 
                target="_blank" 
                rel="noreferrer" 
                className="w-11 h-11 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:bg-zinc-800 hover:border-emerald-500/50 hover:text-emerald-400 transition-all"
              >
                <BsTwitterX size={18} />
              </a>
              <a 
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-2 sm:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            <div key={s.label} className="text-center">
              <p className="text-5xl sm:text-6xl font-black bg-gradient-to-br from-white to-zinc-400 bg-clip-text text-transparent mb-2">
                {s.number}
              </p>
              <p className="text-zinc-500 text-sm font-bold uppercase tracking-wider">{s.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-32">
        <div className="grid lg:grid-cols-5 gap-16 items-start">
          ...
          <div className="lg:col-span-3 space-y-6 text-lg text-zinc-400 leading-relaxed">
          ...
          <p className="text-center text-green-400 font-bold text-lg">#Allan Andeba</p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {reasons.map((r) => (
              <div 
                ...
                hover:border-emerald-500/30 rounded-3xl p-8 transition-all duration-300 hover:scale-105 hover:cursor-pointer"
              >
                <div className={`w-14 h-14 rounded-2xl bg-${r.color}-500/10 border-2 border-${r.color}-500/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                  {r.icon}
                </div>
                <h3 className="text-white font-black text-xl mb-4">{r.title}</h3>
                <p className="text-zinc-400 text-base leading-relaxed">{r.body}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="space-y-10 pl-16">
            {timeline.map((t, i) => (
              <div key={i} className="relative group">
                ...
                <div className="absolute -left-[49px] top-2 w-[18px] h-[18px] rounded-full border-4 border-emerald-500 
                bg-zinc-950 shadow-lg shadow-emerald-500/30 group-hover:scale-125 transition-transform" />
                
                <div className="bg-zinc-900/30 border-2 border-zinc-800 rounded-2xl p-6 group-hover:border-emerald-500/30 transition-all">
                  <p className="text-emerald-400 text-xs font-black uppercase tracking-widest mb-3">
                    {t.date}
                  </p>
                  <p className="text-zinc-300 text-base leading-relaxed font-medium">{t.event}</p>
                </div>
              </div>
            ))}
          </div>
  ...
  <WeeklyTopics />
      ...
      <section className="relative border-t-2 border-emerald-500/20 bg-gradient-to-b from-zinc-900 to-zinc-950 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-32 text-center">
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-6 leading-none">
            Uko kadi?
          </h2>
          <p className="text-zinc-400 text-lg sm:text-xl mb-14 max-w-2xl mx-auto leading-relaxed">
          ...
          <Link
            to="/pin-location"
            className="group inline-flex items-center gap-3 bg-emerald-500 hover:bg-emerald-400 text-black font-black text-lg px-8 py-4 rounded-2xl
          ...
          <p className="text-zinc-600 text-sm font-bold mt-8 uppercase tracking-widest">
